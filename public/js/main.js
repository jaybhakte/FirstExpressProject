...
let getinfo = async (e) => {
    ...
    if (cityVal === '') {
        ...
        try {
            ...
            const temprature_update = arrData[0].main.temp;
            temp_real_val.innerText = Math.round(temprature_update/10);
            // console.log(temp_real_val.innerText);
            ...
            city_name.innerText = 'Please enter the city name properly or kindly check your Internet!';
            temp.innerHTML = '';
